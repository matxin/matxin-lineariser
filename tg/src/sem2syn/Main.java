	...
	throws IOException, InterruptedException, ClassNotFoundException {
		...
		for(; iter < options.numIters; iter++) {
			...
			for(int n = 0; n < numInstances; n++) {
				...
				//				if (gs[n].countNodes(Graph.NODE)!=len) {
				//					DB.println("number of nodes different g "+gs[n].countNodes(Graph.NODE)+" dsynt "+len);
				//					continue;
				//				}

				// no deep map
			//	if (n==1893 || n==7063||n==7540|| n==9105 || n==9109 || n==9112||n==11804||n==12224 || n==14250 || n==14287 || n==17634|| n==17638 ) continue;

			//	if (n==17655 ||n==19722 || n==19723 || n==26346 || n==26599 || n==29236 || n==29237 || n==26598 || n==26347 || n==23591 || n==23102 || n==22812) continue;
				if(dist[n]==null) {
