...
//		int hl = h==-1?-1:is.labels[i][h];
		...
		// head label
//		drw.v0 = n++;                                          drw.v4=hl; drw.v5= h1; drw.v6= pred; l= mf.calc7(drw); f.add(li.l2i(l)); f.add(li.l2i(drw.calcs(s_pos,i2,l)));			
	...
	public void extractGlobal(Instances is, int i, int[] path, IFV f) {
		...
		int lenp = path.length>=3?3:path.length;
	
		//lenp=0;

		int ll =is.labels[i][path[path.length-1]];
		int l1 =is.labels[i][path[0]];
		int l2 =is.labels[i][path[1]];
		int llm2=is.labels[i][path[path.length-2]];
		
		dr.v0=n++; dr.v1=l1; dr.v2=ph;    dr.v3=ll; dr.v4=llm2;  dr.v5=questionMark; 	l= mf.calc6(dr); f.add(li.l2i(l));  	

		dr.v0=n++; dr.v1=l1; dr.v2=ph; dr.v3=ll;  dr.v4=questionMark; f.add(li.l2i(mf.calc5(dr)));  	

		drrrww.v0=n++; drrrww.v1=l1;  drrrww.v2=ll; drrrww.v3=fH; drrrww.v4=questionMark; f.add(li.l2i(mf.calc5(drrrww)));  	

		drrrww.v0=n++; drrrww.v1=l1;  drrrww.v2=ll; drrrww.v3=is.glemmas[i][path[path.length-2]]; drrrww.v4=questionMark; f.add(li.l2i(mf.calc5(drrrww)));  	
		drrrww.v0=n++; drrrww.v1=l1;  drrrww.v2=ll; drrrww.v3=is.glemmas[i][path[path.length-1]]; drrrww.v4=questionMark; f.add(li.l2i(mf.calc5(drrrww)));  	
		
		drrw.v0=n++; drrw.v1=l1; drrw.v2=ph; drrw.v3=ll; drrw.v4=l2; drrw.v5=questionMark; f.add(li.l2i(mf.calc6(drrw)));  	
