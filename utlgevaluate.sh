...
for d in *; do
        ...
        cat test|python3 "${prefix}/utlgevaluate.py" train_projective.xml ref_test_projective.sgm src_test_projective.sgm "$(cat trglang)" 1_test_projective.sgm "${mteval}" 100 --figure-2="${data_prefix}/test/figure_2.pdf"
