...
for d in *; do
        ...
        prefix="/home/matthew/github.com/matxin/matxin-lineariser"
        data_prefix="${prefix}/matxin_lineariser/utlgrammars/test/evaluation/${d}"
        ...
        cat test|python3 "${prefix}/utlgevaluate.py" train_projective.xml ref_test_projective.sgm src_test_projective.sgm "$(cat trglang)" 1_test_projective.sgm "${mteval}" 100 --figure-2="${data_prefix}/test/projective/figure_2.pdf" --projectivise
        ...
        cat train|python3 "${prefix}/utlgevaluate.py" train_projective.xml ref_train_projective.sgm src_train_projective.sgm "$(cat trglang)" 1_train_projective.sgm "${mteval}" 1 --projectivise
